...
import (
        ...
        "universalengagement/control-plane/internal/audit"
...
func (s *Server) CreateObject(w http.ResponseWriter, r *http.Request) {
        ...
        audit.Record(r.Context(), s.Pool, obj.ProjectID, obj.EnvironmentID, "config.create", obj.Type, obj.ID, nil, map[string]any{"name": obj.Name, "status": obj.Status}, "")
...
func (s *Server) UpdateObject(w http.ResponseWriter, r *http.Request) {
        ...
        audit.Record(r.Context(), s.Pool, obj.ProjectID, obj.EnvironmentID, "config.update", obj.Type, obj.ID, nil, map[string]any{"config": req.Config}, "")
        writeJSON(w, http.StatusOK, obj)
}
...
func (s *Server) PublishObject(w http.ResponseWriter, r *http.Request) {
        ...
        audit.Record(r.Context(), s.Pool, obj.ProjectID, obj.EnvironmentID, "config.publish", obj.Type, obj.ID, nil, map[string]any{"version": obj.PublishedVersion, "status": obj.Status}, "")
        writeJSON(w, http.StatusOK, obj)
}
...
func (s *Server) PauseObject(w http.ResponseWriter, r *http.Request) {
        ...
        audit.Record(r.Context(), s.Pool, pathID(r, "projectId"), pathID(r, "environmentId"), "config.pause", "object", pathID(r, "objectId"), nil, map[string]any{"status": "paused"}, "")
...
func (s *Server) ResumeObject(w http.ResponseWriter, r *http.Request) {
        ...
        audit.Record(r.Context(), s.Pool, pathID(r, "projectId"), pathID(r, "environmentId"), "config.resume", "object", pathID(r, "objectId"), nil, map[string]any{"status": "active"}, "")
...
func (s *Server) RollbackObject(w http.ResponseWriter, r *http.Request) {
        ...
        audit.Record(r.Context(), s.Pool, obj.ProjectID, obj.EnvironmentID, "config.rollback", obj.Type, obj.ID, nil, map[string]any{"to_version": version}, "")
        writeJSON(w, http.StatusOK, obj)
}
...
func (s *Server) DeleteObject(w http.ResponseWriter, r *http.Request) {
        ...
        audit.Record(r.Context(), s.Pool, pathID(r, "projectId"), pathID(r, "environmentId"), "config.delete", "object", pathID(r, "objectId"), nil, map[string]any{"status": "archived"}, "")
...
func (s *Server) PromoteObject(w http.ResponseWriter, r *http.Request) {
        ...
        obj, err := configsvc.Promote(r.Context(), s.Pool, pathID(r, "projectId"), pathID(r, "environmentId"),
                req.ToEnvironment, pathID(r, "objectId"), actorOf(r))
        if err != nil {
                writeErr(w, err)
                return
        }
